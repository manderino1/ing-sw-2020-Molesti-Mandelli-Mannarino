...
public class TestApollo extends TestDivinity {
    ...
    public void createPlayerManager() {
        ...
        socketThread.start();
        playerManager = new PlayerManager(matchRun, new PlayerData("Test", Color.RED, 0), "Apollo" , matchSocket);
    ...
    public void testUpdateMoveCells() {
        ...
        Assert.assertEquals(playerManager1.getWorker(0), matchRun.getGameMap().getCell(1,0).getWorker());
    }
}