...
public class TestMatchManager {
    ...
    public void testMatchManagement() {
        ...
        SocketThread socketThread2 = new SocketThread(socket, matchManager, true);
        socketThread2.setMatchSocket(matchManager.getMatchSocket(2));
        socketThread2.start();
        SocketThread socketThread3 = new SocketThread(socket, matchManager, true);
        socketThread3.setMatchSocket(matchManager.getMatchSocket(2));
        socketThread3.start();
        SocketThread socketThread4 = new SocketThread(socket, matchManager, true);
        socketThread4.setMatchSocket(matchManager.getMatchSocket(2));
        socketThread4.start();
        Assert.assertNotEquals(match1, matchManager.getMatchSocket(2));
        socketThread = new SocketThread(socket, matchManager, true);
        socketThread.setMatchSocket(matchManager.getMatchSocket(3));
        socketThread.start();
        match1 = matchManager.getMatchSocket(3);
        socketThread2 = new SocketThread(socket, matchManager, true);
        socketThread2.setMatchSocket(matchManager.getMatchSocket(3));
        socketThread2.start();
        socketThread3 = new SocketThread(socket, matchManager, true);
        socketThread3.setMatchSocket(matchManager.getMatchSocket(3));
        socketThread3.start();
        socketThread4 = new SocketThread(socket, matchManager, true);
